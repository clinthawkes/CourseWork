...
int main()
{
	...
	assertTrue(listStackPop(s) == 500, "\npopping; val == 500");
	assertTrue(listStackPop(s) == -100, "popping; val == -100");
	assertTrue(listStackPop(s) == -300, "popping; val == -300");
	...
	assertTrue(listStackPop(s) == 9, "popping; val == 9");
	assertTrue(listStackTop(s) == 8, "top val == 8\t");
	assertTrue(listStackIsEmpty(s) == 0, "stackIsEmpty == 0");
